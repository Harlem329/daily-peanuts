...
Simple cron worker that checks a gocomics.com page once daily at 2 PM UTC (6 AM PST, 9 AM EST) for a new comic, then sends the comic image (if any) to a Discord webhook. I made this for Peanuts, hence the name you cann substitute any valid comic from GoComics (e.g. `garfield`, `peanuts-begins`).
